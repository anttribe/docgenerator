...
<head>
    ...
    <meta charset="utf-8">
    <title>赵勇的简历-拉勾网-最专业的互联网招聘平台</title>
...
<div id="container">
    ...
    <div class="basic" id="baseInfo">
        <div class="basic-photo">
            <img class="mr_headimg user-avatar" id="userpic" src="${resume.personalInfo.avator!''}" width="120" height="120" alt="头像" />
        </div>
        <div class="basic-info">
            <div class="basic-name-area">
                <p class="basic-name female">${resume.personalInfo.name!''}</p>
            ...
            <p>
                <span class="basic-tel">
                   ...
                   <span>${resume.personalInfo.telephone!''}</span>
                </span>
